...
namespace SalesAPI.Entities
{
    public class SequentialGuid
    {
        ...
        public TimeSpan TimePerSequence
        {
            get
            {
                var ticksPerSequence = TotalPeriod.Ticks / _maximumPermutations; var result = new TimeSpan(ticksPerSequence);
                return result;
            }
        }
        ...
        internal Guid GetGuid(DateTime now)
        {
            ...
            var sequence = GetCurrentSequence(now); return GetGuid(sequence);
        }
